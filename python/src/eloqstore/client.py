    ...
    def __init__(self, options: ClientOptions):
        ...
        try:
            ...
            if options.options_path:
                _ok(lib().CEloqStore_Options_LoadFromIni(opts, _encode(options.options_path)))
            ...
            lib().CEloqStore_Options_SetPagesPerFileShift(opts, options.pages_per_file_shift)
            lib().CEloqStore_Options_SetOverflowPointers(opts, options.overflow_pointers)
